...
public class GroupChatAppMsgAdapter extends RecyclerView.Adapter<ChatAppMsgViewHolder> {
    ...
    public GroupChatAppMsgAdapter(List<ChatAppMsgDTO> msgDtoList,Context context) {
...
//        this.imageOtherUser = imageOtherUser;
    ...
    public void onBindViewHolder(final ChatAppMsgViewHolder holder, int position) {
        ...
        if(!msgDto.getUser_id().equalsIgnoreCase(PersistData.getStringData(context,AppConstant.loginUserid)))
        {
...
//            }
            holder.leftMsgTextView.setText(msgDto.getMessage_body());
            holder.text_message_name.setText(msgDto.getName());
...
//            }
            ...
            holder.rightMsgTextView.setText(msgDto.getMessage_body());
