...
public class AdapterSeraContent extends PagerAdapter {
    ...
    // constructor
    public AdapterSeraContent(Context con, int img[], String name[]) {
        this.con = con;
        this.img = img;
        this.name = name;
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        final View viewLayout = inflater.inflate(R.layout.viewpager_content_item,
                container, false);
