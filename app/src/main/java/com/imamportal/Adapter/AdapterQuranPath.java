...
public class AdapterQuranPath extends RecyclerView.Adapter<AdapterQuranPath.MyViewHolder> {
    ...
    public AdapterQuranPath(List<SantirbaniInfo> santirBaniList, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.raw_quran_pat, parent, false);
