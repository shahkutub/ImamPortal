...
public class VideoPostAdapter extends RecyclerView.Adapter<VideoPostAdapter.MyViewHolder> {
    ...
    public VideoPostAdapter(List<SantirbaniInfo> santirBaniList, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.raw_video_post, parent, false);
