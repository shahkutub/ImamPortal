...
public class FragmentOnnannoQuran extends Fragment {
    ...
    private void initUi() {
        ...
        Log.e("dataListList",""+dataListList.size());

        for (int i = 0; i < AppConstant.listAlqranAlhadith.size(); i++) {
                if(AppConstant.listAlqranAlhadith.get(i).getCategory_id().equalsIgnoreCase("47")){
