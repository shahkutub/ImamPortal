...
public class FragmentVideohamdnat extends Fragment implements SwipyRefreshLayout.OnRefreshListener{
            ...
            public void onResponse(Call<CommonPostResponse> call, Response<CommonPostResponse> response) {
                ...
                if(commonPostResponse !=null){
                    ...
                    if(commonPostResponse.getData().size()>0){
                        ...
                        VideoAdapter questionAnsAdapter = new VideoAdapter(listSantirbani,context);
