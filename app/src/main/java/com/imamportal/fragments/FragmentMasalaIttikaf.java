...
public class FragmentMasalaIttikaf extends Fragment {

    private RecyclerView recyclSantirBani;
    private TextView tvTotalBani,tvName;
    Context context;

    public FragmentMasalaIttikaf() {
    ...
    private void initUi() {
        ...
        for (int i = 0; i < AppConstant.listAllBlogPost.size(); i++) {
                ...
                if(AppConstant.listAllBlogPost.get(i).getCategory_id().equalsIgnoreCase("25")){
